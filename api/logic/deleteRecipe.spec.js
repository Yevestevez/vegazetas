        ...
        return User.create({ name: 'Frodo Baggins', email: 'frodo@baggins.com', username: 'frodobaggins', password: '123123123' })
            .then(user => {
                return Recipe.create({
                    ...
                    .then(recipe => {
                        return deleteRecipe(user._id.toString(), recipe._id.toString())
                    })
                    .then(result => {
        ...
        return User.create({ name: 'Frodo Baggins', email: 'frodo@baggins.com', username: 'frodobaggins', password: '123123123' })
            .then(user => {
                return Recipe.create({
                    ...
                    .then(recipe => {
                        return deleteRecipe(new ObjectId().toString(), recipe._id.toString())
                    })
        ...
        return User.create({ name: 'Frodo Baggins', email: 'frodo@baggins.com', username: 'frodobaggins', password: '123123123' })
            .then(user => {
                return Recipe.create({
                    ...
                    .then(recipe => {
                        return deleteRecipe(user._id.toString(), new ObjectId().toString())
                    })
                    .catch(error => catchedError = error)
                    .finally(() => {
                        expect(catchedError).to.be.instanceOf(NotFoundError)
        ...
        return User.create({ name: 'Frodo Baggins', email: 'frodo@baggins.com', username: 'frodobaggins', password: '123123123' })
            ...
            .then(user2 => {
                ...
                return Recipe.create({
                    ...
                    .then(recipe => {
                        return deleteRecipe(frodo._id.toString(), recipe._id.toString())
                    })
                    .catch(error => catchedError = error)
                    .finally(() => {
