            ...
            .then(user => {
                return Recipe.create({
                    ...
                    .then(recipe => {
                        ...
                        return removeIngredientFromRecipe(user._id.toString(), recipe._id.toString(), ingredient._id.toString())
                    })
                    .then(() => {
                        return Recipe.findOne()
                    })
                    .then(recipe => {
                        expect(recipe.ingredients).to.be.an('array').with.lengthOf(0)
                    })
            })
    })
