function Landing({ onLoginClicked, onRegisterClicked }) {
    ...
    const btnClasses = `
        ...
        hover:xl:drop-shadow-[1.2vw_1.2vw_0_rgba(0,0,0,0.7)]
        hover:-translate-y-2 hover:scale-105
    `

    return <div className="
        /* Layout */
        flex flex-col min-h-screen min-w-screen items-center gap-[14vw] sm:gap-[10vw] md:gap-[8vw] xl:gap-[4vw]
    ...
    ">
        <h1 className="
            /* Layout */
            text-center mt-[38vw] 
            sm:mt-[24vw] md:mt-[22vw] xl:mt-[8vw]
        ...
        ">
            <a className={`
                ...
                xl:text-[clamp(min(1.5vw,10rem),2.6vw,10rem)]
            ...
            <a className={`
                ...
                xl:text-[clamp(min(2vw,10rem),2vw,10rem)]
