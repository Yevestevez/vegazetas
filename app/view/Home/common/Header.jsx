...
function Header({ onUserLoggedOut, onLogoClicked }) {
    ...
    return <div className="
        /* Layout */
        fixed top-0 xl:left-0 z-10

        w-full xl:w-[40vw]
        xl:h-[45vh] xl:overflow-y-auto

        flex flex-row xl:flex-col justify-between xl:items-end

        py-[4vw] sm:py-[3vw] xl:py-[0vw]
        px-[8vw] sm:px-[6vw] md:px-[5vw] xl:px-[0vw]
        ...
        <div className="flex flex-row xl:flex-col items-center h-full w-full xl:w-[20vw] justify-between xl:justify-center xl:gap-[3vw]">
            <a href="" onClick={handleLogoLinkClick}>
                <h1 className="  
                    ...
                    /* Tipografía */
                    anybody-logo
                    text-[8vw]/[80%] sm:text-[7vw]/[80%] md:text-[6vw]/[80%] xl:text-[4.5vw]/[80%]
                    text-sgbus-green
            ...
            <div className="
                /* Layout */
                flex flex-row xl:flex-col gap-[2vw] xl:gap-[1vw] items-center align-middle justify-center
            ">
                <button className="
                    anybody text-[2.7vw]/[120%] xl:text-[0.7vw]/[120%]
                    text-sgbus-green
                    order-1 xl:order-2
                    cursor-pointer
                ...
                <FaRegUserCircle className="
                    ...
                    /* Tamaño */
                    text-[13vw] sm:text-[11vw] md:text-[10vw] xl:text-[5vw]
